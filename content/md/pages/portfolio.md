...
the [tree-sitter framework][ts] for parsing text into AST. Currently, it only has basic diagnostic features,
...
This also means we are working with a 1.0 MB binary file memory footprint instead of the 2.8 MB text file
